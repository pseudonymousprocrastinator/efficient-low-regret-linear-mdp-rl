...
echo "Output directory: ${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-short-<algparams>"
...
mkdir -p "$OUTPUT_DIR"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-short-0p5"  --k-min 100 --num-reps $NUM_REPS --chunk-size 5 --learn-iters-base-exp 0.5  alt_fixed_reset 5000 "$MODEL_FILENAME"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-short-0p6"  --k-min 100 --num-reps $NUM_REPS --chunk-size 5 --learn-iters-base-exp 0.6  alt_fixed_reset 5000 "$MODEL_FILENAME"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-short-0p7"  --k-min 100 --num-reps $NUM_REPS --chunk-size 5 --learn-iters-base-exp 0.7  alt_fixed_reset 5000 "$MODEL_FILENAME"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-short-0p75" --k-min 100 --num-reps $NUM_REPS --chunk-size 5 --learn-iters-base-exp 0.75 alt_fixed_reset 5000 "$MODEL_FILENAME"
# END

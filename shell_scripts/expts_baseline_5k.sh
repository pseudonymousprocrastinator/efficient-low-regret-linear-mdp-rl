...
echo "Output directory: ${OUTPUT_DIR}/${OUTPUT_PREFIX}-baseline"
...
mkdir -p "$OUTPUT_DIR"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-baseline" --k-min 100 --num-reps $NUM_REPS --chunk-size 5 basic 5000 "$MODEL_FILENAME"

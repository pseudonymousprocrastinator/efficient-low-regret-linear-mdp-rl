...
echo "Output directory: ${OUTPUT_DIR}/${OUTPUT_PREFIX}-ad-r-long"
...
mkdir -p "$OUTPUT_DIR"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-ad-r-long" --k-min 100 --num-reps $NUM_REPS --chunk-size 5 alt_adaptive_reset 10000 "$MODEL_FILENAME"
# END

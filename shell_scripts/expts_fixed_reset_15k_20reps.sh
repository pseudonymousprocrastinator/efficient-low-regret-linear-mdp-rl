...
echo "Output directory: ${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-long"
...
mkdir -p "$OUTPUT_DIR"
python experiment_base.py -n $NUM_MP_JOBS -o "${OUTPUT_DIR}/${OUTPUT_PREFIX}-fi-r-long" --k-min 100 --num-reps $NUM_REPS --chunk-size 5 alt_fixed_reset 15000 "$MODEL_FILENAME"
# END
